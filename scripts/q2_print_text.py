...
from q2_frame_probe import NOTIFY_CHARS, WRITE_CHAR, parse_yk_frame, resolve_address, sender_id, yk_frame
...
async def main() -> None:
    ...
    if args.preview:
        ...
        if args.preview_only:
            print(json.dumps({"preview": str(out), "text": args.text}, indent=2))
            return
